 ...
 * @SPI_BusConfig
 */
#define SPI_BUS_CONFIG_FD               0 /* SPI Full-duplex bus configuration          */
#define SPI_BUS_CONFIG_HD               1 /* SPI Half-duplex bus configuration          */
#define SPI_BUS_CONFIG_SIMPLEX_RX_ONLY  2 /* SPI Simplex bux receive only configuration */
